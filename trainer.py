...
from models.vae_mog import MoGPrior, BernoulliLikelihood, \
    Guide, MoGVAE
...
def train_vae(params, device):
    ...
    Bern_likelihood = BernoulliLikelihood(z_dim=z_dim,
                            hidden_dim=hidden_dim)
    mog_guide = Guide(z_dim=z_dim,
                         hidden_dim=hidden_dim)
    vae = MoGVAE(prior=mog_prior,
              likelihood=Bern_likelihood,
              guide=mog_guide,
             device=device)
